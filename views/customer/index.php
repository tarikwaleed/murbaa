							...
							<tbody>
								...
								<tr v-for="(x ,index) in owner">
									...
									<td>
										...
										<button  type="button" class='btn btn-primary rounded btn-sm ' data-toggle="modal" 
										:data-target="'#staff_'+x.ID" style="margin-top: 5px;">اهداء باقة  </button>

										<div class="modal fade" :id="'staff_'+x.ID" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
										<form method="POST" action="<?php echo URL?>customer">
											<input type="hidden" name="edit_package" value="edit"> 

											<input type="hidden" name="id_customer" v-bind:value="x.ID">

										  <div class="modal-dialog" role="document">
										    <div class="modal-content">
										      <div class="modal-header">
										        <h5 class="modal-title" id="exampleModalLabel">تغيير الباقة</h5>
										        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
										          <span aria-hidden="true">&times;</span>
										        </button>
										      </div>
										      <div class="modal-body">
										      <select name="id_pack" id="id_pack" class="form-control" >
												<option value="" > الباقة</option>
												<option v-for="p in pack" 
