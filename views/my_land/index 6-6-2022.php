			...
			<form class="filter-form" id="land_search" v-on:submit.prevent="onSubmitSearch" method="POST" action="<?php echo URL?>my_land/">
				...
				<div class="">
					...
					<div class="row">
						...
						<div class="col-sm mb-3" v-if="config.AREA - config.ALL_LANDS > 0 && config.ACCEPT == 1 && config.ID_NO && config.ID_TYPE">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<h4>للأسف لا يمكنك اضافة اعلان, عليك التحقق من بيانات الحساب</h4>
					<br/>
					<div v-if="config.ACCEPT != 1"> عليك توثيق حسابك قبل اضافة إعلان <a href="<?php echo URL?>my_co/registration">الذهاب لصفحة التوثيق</a></div>
					<div v-if="config.AREA - config.ALL_LANDS <= 0"> لقد بلغ عدد الاعلانات الحد المسموح به, قم بترقية حسابك لكي تضيف اعلان جديد</div>
					<div v-if="config.ID_NO === null || config.ID_TYPE === null"> عليك اضافة بيانات اثبات شخصية لحسابك</div>
				</div>
					...
					<div class="modal-body">
						...
						<div class="row mt-3">
							<div class="col-sm mb-3">
								...
								<input type="number" lang="en" name="new_block" id="new_block" class="form-control border border-primary rounded" placeholder="المربع" required />
								<div class="d-none err_notification" id="valid_new_block">this field required</div>
							</div>
							<div class="col-sm mb-3">
								<label for="new_no" class="">رقم العقار</label>
								<input type="number" lang="en" id="new_no" name="new_no" class="form-control border border-primary rounded" placeholder="رقم العقار" required />
							...
							<div class="col-sm mb-3">
								...
								<input type="number" lang="en" step="any" id="new_space" name="new_space" class="form-control border border-primary rounded" placeholder="المساحة" required />
						...
						<div class="row">
							...
							<div class="col-sm mb-3" v-if="delegate">
								<label for="new_relation_type" class="">نوع التفويض</label>
								<select name="new_relation_type" id="new_relation_type" class="form-control" @change="onChangeRelation_type($event)" >
									<option value=""></option>
						...
						<div class="row">
							<div class="col-sm mb-3">
								...
								<input type="number" lang="en" id="new_price" name="new_price" class="form-control border border-primary rounded" placeholder="السعر" required />
						...
						<div class="row">
                            <div class="col-sm mb-3 new_home_area">
								...
								<input type="number" lang="en" id="new_unit_no" name="new_unit_no" class="form-control border border-primary rounded" placeholder="الوحدة" />
						...
						<div class="row" >
							<div class="col-sm mb-3 new_home_area">
								...
								<input type="range" min="0" max="80" data-view="new_r_range_val" value="0" id="new_rooms" name="new_rooms" class="form-control-range range_input" />
								<div class="d-none err_notification" id="valid_new_type">this field required</div>
							</div>	
							<div class="col-sm mb-3 new_home_area">
						...
						<div class="row">
							...
							<div class="col-sm mb-3">
								...
								<input type="range" min="2" max="150" step="2" data-view="new_road_range_val" name="new_road" class="form-control-range range_input" />
						...
						<div class="row">
							<div class="col-sm mb-3">
								...
								<textarea type="text" id="new_mortage" name="new_mortage" class="form-control border border-primary rounded" placeholder="لا يوجد" >لا يوجد</textarea>
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-sm mb-3 upd_home_area">
								...
								<input type="range" min="0" max="80" data-view="upd_r_range_val" :value="(upd_land.ROOMS == null)?0:upd_land.ROOMS" id="upd_rooms" name="upd_rooms" class="form-control range_input" />
						...
						<div class="row">
							...
							<div class="col-sm mb-3">
								...
								<input type="range" min="2" max="150" step="2" :value="(upd_land.ROAD == null)?0:upd_land.ROAD" data-view="upd_road_range_val" name="upd_road" id="upd_road" class="form-control range_input" />
