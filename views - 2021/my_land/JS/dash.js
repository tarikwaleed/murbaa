...
paylib.inlineForm({
	'key': JS_KEY,
	'form': document.getElementById('land_bill_form'),
	'autoSubmit': true,
	'callback': function(response) 
	{
		document.getElementById('land_bill_form_error').innerHTML = '';
		if (response.error) 
		{             
			paylib.handleError(document.getElementById('land_bill_form_error'), response); 
		}
	}
});
