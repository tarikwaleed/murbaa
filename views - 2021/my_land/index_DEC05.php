				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-sm mb-3">
								<input type="file" name="new_land_img" class="file-upload image_upload form-control-file form-control-sm" data-id="new_land_img" id="img" accept="image/*" />
						...
						<div class="row">
							<div class="col-sm  mb-3">
								...
								<input type="file" name="new_file_image[]" class="file-upload multi_image_upload form-control-file" data-id="new_images_area" multiple />
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-sm mb-3">
								<input type="file" name="upd_land_img" class="file-upload image_upload form-control-file form-control-sm" data-id="upd_land_img" id="img" accept="image/*" />
								<div class="d-none err_notification" id="valid_new_land_img">this field required</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-sm  mb-3">
								...
								<input type="file" name="upd_file_image[]" class="file-upload multi_image_upload form-control-file" data-id="upd_images_area" multiple />
