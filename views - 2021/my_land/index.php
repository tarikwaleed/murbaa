						...
						<div class="col p-4 d-flex flex-column position-static">
							<div class="pi-text">
								...
								<div class="mt-2">
									...
									<button v-if="config.PK_PRICE == 1 && x.BILL == 0" v-on:click.prevent="by_land(land_index)" class='btn btn-success mb-3' data-toggle="modal" data-target="#land_price" >دفع عمولة الاعلان</button>
								</div>
							</div>
						</div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC9LAtPj0KJDr5l621IbMZcQinoYO-7-4g&v=weekly"></script>
