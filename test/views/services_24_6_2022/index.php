...
<main class="col-md-9 ms-sm-auto col-lg-12 px-md-4 vue_area_div">
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		<h4 class="h4"><i class="fa fa-users text-primary"></i> الخدمات</h4>
	</div>
	...
	<div class="property-comparison-section">
		<div class="row property-filters ">
			<div v-for="(x, index) in service_list" v-if="x.CO_ID == config.ID || x.STATUS == 'NEW' || x.CURR_OFF == x.MY_OFFER" class="col-md-12 property-item g-0 border bg-hover-light rounded-lg overflow-hidden flex-md-row mb-2 shadow-sm position-relative">
				<div class="row ">
					...
					<div class="col-4 row" v-if="x.CO_ID == config.ID">
						<div class="col-6 p-1" v-if="x.OFFERS.length == 0">
						...
						<div class="col-6 p-1" v-if="x.STATUS == 'FREEZ' || x.STATUS == 'NEW' ">
	...
	<div id="new_service" class="modal fade modal_with_form" tabindex="-1" aria-labelledby="new_service_title" aria-hidden="true">
		<div class="modal-dialog modal-lg text-right" role="document">
			<form class="row g-3 model_form" id="new_type_form" method="post" action="<?php echo URL?>services/new_service" data-model="new_service" data-type="new" enctype="multipart/form-data">
