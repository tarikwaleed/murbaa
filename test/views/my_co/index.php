...
<main id="staff_info" class="col-md-9 ms-sm-auto col-lg-12 px-md-4 vue_area_div">
	...
	<div class="d-flex justify-content-center ">
		<form class="g-3 border p-5 mb-3" id="staff_form"  v-on:submit.prevent="onSubmitupd" method="post" action="<?php echo URL?>my_co/upd" enctype="multipart/form-data">
			...
			<div class="row mb-3">
				<div class="col-sm">
					<label for="new_co_email" class="">Client ID </label>
					<input type="text" v-bind:value="info.CLIENT_ID" class="form-control" name="new_client_id" placeholder="API Client ID " >
					<div class="d-none err_notification" id="valid_new_client_id">this field required</div>
				</div>
			</div>
			<div class="row mb-3">
				<div class="col-sm">
					<label for="new_id_no" class="">Client Secrit</label>
					<input type="text" v-bind:value="info.CIENT_SEC" class="form-control" name="new_client_sec" placeholder="API Client Secrit" >
					<div class="d-none err_notification" id="valid_new_client_sec">this field required</div>
				</div>
			</div>
			<div class="row mb-3">
				<div class="col-sm">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-sm mb-3" :class="(total ==0)?'d-none':''">
								<label for="vip_price" class="">رمز التخفيض</label>
