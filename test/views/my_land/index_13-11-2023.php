		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<br/>
					<div v-if="config.ACCEPT != 1"> عليك توثيق حسابك قبل إضافة إعلان <a href="<?php echo URL?>my_co/registration">الذهاب لصفحة التوثيق</a></div>
					<div v-if="config.AREA - config.ALL_LANDS <= 0"> لقد بلغ عدد الإعلانات الحد المسموح به, قم بترقية حسابك لكي تضيف إعلان جديد</div>
					<div v-if="config.ID_NO === null || config.ID_TYPE === null"> عليك إضافة بيانات إثبات شخصية لحسابك</div>
				</div>
