...
<main class="col-md-9 ms-sm-auto col-lg-12 px-md-4 vue_area_div">
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		<h4 class="h4"><i class="fa fa-users text-primary"></i>  العقود</h4>
	</div>
			...
			<form class="filter-form" id="service_search" v-on:submit.prevent="onSubmitSearch" method="POST" action="<?php echo URL?>services/">
				<div class="">
					...
					<div class="row">
						...
						<div class="col-sm mb-3">
							<a class="btn btn-block btn-primary" href="<?php echo URL?>services/index/my_project" >مشاريعي</a>
						</div>
						<div class="col-sm mb-3">
						...
						<div class="col-sm mb-3" >
							<a class="btn btn-block btn-primary" href="<?php echo URL?>services/users" >مقدمي الخدمات</a>
						</div>
					</div>
				</div>
			</form>
	...
	<div class="property-comparison-section">
		<div class="row property-filters ">
			<div v-for="(x, index) in service_list" v-if="x.CO_ID == config.ID || (x.CURR_OFF == x.MY_OFFER && x.CURR_OFF != null) || (x.STATUS == 'NEW' && x.CURR_OFF == null)" class="col-md-12 property-item g-0 border bg-hover-light rounded-lg overflow-hidden flex-md-row mb-2 shadow-sm position-relative">
				<div class="row ">
				...
				<div class="row bg-success" v-if="(x.STATUS == 'WORK' || x.STATUS == 'SIM_END') && (x.CO_ID == config.ID || x.MY_OFFER == x.CURR_OFF)"> قيد التنفيذ </div>
				<div class="row " v-html="x.D_SM_DESC"></div>
			</div>
		</div>	
	</div>
			...
			<form class="row g-3 model_form" id="new_type_form" method="post" action="<?php echo URL?>services/new_service" data-model="new_service" data-type="new_service">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<input type="hidden" class="" name="ser_sel" value="0" />
						<div class="col-auto">
