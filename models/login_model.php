	...
	class login_model extends model
	{
		...
		*/
		public function reg()
		{
			...
			$MSG = "<div dir='rtl'>عميلنا العزيز: ".$req['usrname']."<br/>
					مرحبا بك في ".TITLE." ويشرفنا انضمامكم ونسعد بخدمتكم<br/>
					خدمة العملاء<br/>
					".TITLE." .. عقار المستقبل <br/> Murbaa.com </div>";
			...
			$co_array = array('co_name'		=>$req['usrname']
							...
							,'co_phone'		=>$req['phone']
							,'co_email'		=>$req['email']
							,'co_invite_by'	=>(!empty($req['from']))?$req['from']:null
							,'create_at'	=>$time
